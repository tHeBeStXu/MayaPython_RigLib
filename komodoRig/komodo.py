...
def build(characterName):
    ...
    cmds.parent(rootJnt, baseRig.jointGrp)
...
def makeControlSetup(baseRig):
    ...
    cmds.setAttr('l_hand1_jnt.jo', 138.28570432475698, -48.90539524404269, -30.284152362844438)
    cmds.setAttr('r_hand1_jnt.jo', 138.28570432475684, -48.905395244042566, -30.28415236284434)
    ...
    neckRig = neck.build(neckJoints=neckJoints,
                         headJnt=headJnt,
                         neckCurve='neck_crv',
                         prefix='neck',
                         rigScale=sceneScale,
    ...
    cmds.parentConstraint(spineJoints[-2], neckRig['baseAttachGrp'], mo=1)
    cmds.parentConstraint(spineRig['bodyCtrl'].C, neckRig['bodyAttachGrp'], mo=1)
    ...
    cmds.parentConstraint(pelvisJnt, tailRig['baseAttachGrp'], mo=1)
    ...
    cmds.parentConstraint(jawJnt, tongueRig['baseAttachGrp'], mo=1)
    ...
    cmds.parentConstraint(spineJoints[-2], lArmRig['baseAttachGrp'], mo=1)
    cmds.parentConstraint(spineRig['bodyCtrl'].C, lArmRig['bodyAttachGrp'], mo=1)
    ...
    cmds.parentConstraint(spineJoints[-2], rArmRig['baseAttachGrp'], mo=1)
    cmds.parentConstraint(spineRig['bodyCtrl'].C, rArmRig['bodyAttachGrp'], mo=1)
    ...
    cmds.parentConstraint(spineJoints[-2], lLegRig['baseAttachGrp'], mo=1)
    cmds.parentConstraint(spineRig['bodyCtrl'].C, lLegRig['bodyAttachGrp'], mo=1)
    ...
    cmds.parentConstraint(spineJoints[-2], rLegRig['baseAttachGrp'], mo=1)
    cmds.parentConstraint(spineRig['bodyCtrl'].C, rLegRig['bodyAttachGrp'], mo=1)
